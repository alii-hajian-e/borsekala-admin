        ...
        children: [
          Row(
            ...
            children: [
              SvgPicture.asset(
                ...
                colorFilter: ColorFilter.mode(ColorManager.white.withOpacity(0.8), BlendMode.srcIn),
              ),
              const SizedBox(width: AppSize.s8),
              Text(txt ?? '',style: getMediumStyle(color: ColorManager.white.withOpacity(0.8),fontSize: AppSize.s12),textAlign: TextAlign.start),
            ],
          ),
          ...
          Visibility(
            ...
            child: Btn(
              ...
              borderSideColorBtn: ColorManager.black.withOpacity(0.0),
            ),
          )
        ],
      )
