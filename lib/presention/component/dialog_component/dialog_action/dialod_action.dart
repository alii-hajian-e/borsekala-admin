        ...
        child: Column(
          ...
          children: [
            CircleButton(
              ...
              buttonColorCircle: ColorManager.gray1.withValues(alpha: 0.6),
              onPress: null,
              icons: icons,
              colors: ColorManager.gray1.withValues(alpha: 0.6),
              bordersSide: AppSize.s2,
              borderSideColors: ColorManager.gray1.withValues(alpha: 0.6),
            ),
